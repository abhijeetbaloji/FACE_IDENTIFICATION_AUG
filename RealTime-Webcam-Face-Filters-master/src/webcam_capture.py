...
#     current_filter = FILTER_NONE_KEY
#     frames_data = []  # List to store each frame's data for saving to JSON
...
#         }
#         frames_data.append(frame_data)  # Append data for this frame to frames_data
...
#     # Save captured frame data to JSON file after exiting loop
#     with open("captured_frames_data.json", "w") as json_file:
#         json.dump(frames_data, json_file, indent=4)

#     print("All captured frame properties have been saved to 'captured_frames_data.json'.")
...
# # Run the function to capture landmarks and save their average
